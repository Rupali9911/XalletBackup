        ...
        <>
          <View style={{ padding: SIZE(10) }}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'flex-end', marginTop: SIZE(5) }}>
              <Text style={{ fontSize: SIZE(22), fontWeight: 'bold', marginRight: SIZE(10), lineHeight: SIZE(22) }}>
                {priceOnChain}
              </Text>
              <Text style={{ fontSize: SIZE(22), fontWeight: 'bold', color: '#9D9D9D', lineHeight: SIZE(22) }}>
                {baseCurrency ? baseCurrency.key : ""}
              </Text>
              <Text style={{ fontSize: SIZE(15), color: '#9D9D9D', marginLeft: SIZE(10), lineHeight: SIZE(22) }}>
