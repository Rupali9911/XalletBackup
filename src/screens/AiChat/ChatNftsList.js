...
const ChatNftsList = ({ tabTitle }) => {
    ...
    const isNftLoading = searchText ? searchLoading : tabTitle === 'Owned' ? isOwnedLoading : isOtherLoading;
    const nftTotalCount = tabTitle === 'Owned' ? ownedTotalCount : otherTotalCount;
    const nftPageChange = tabTitle === 'Owned' ? ownedPageChange : otherPageChange;
    const nftCursor = tabTitle === 'Owned' ? ownedCursor : otherCursor;
    const searchListing = tabTitle === 'Owned' ? searchList.ownerNFTS : searchList.otherNFTs;
