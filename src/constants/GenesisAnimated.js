...
// first three user owned nfts. Remaining are not actual but dummy and we therefore used the token ids of JP's mainnet nfts
export const INFTUserOwned = [
  {
      collectionAddress: '0x5b5cf41d9EC08D101ffEEeeBdA411677582c9448',
      image: 'https://ik.imagekit.io/xanalia/xana-genesis/body-2a-eyes-6c-clothes-28c-faceaccessories-7b-hairs-37d-earringsright-16b.png',
      mainImage:
          'https://ik.imagekit.io/xanalia/xana-genesis/body-2a-eyes-6c-clothes-28c-faceaccessories-7b-hairs-37d-earringsright-16b.png',
      nftId: networkType === 'testnet' ? 678 : 46712,
      nftName: networkType === 'testnet' ? 'test bike' : ' #8505 Audri',
  ...
  {
      collectionAddress: '0x5b5cf41d9EC08D101ffEEeeBdA411677582c9448',
      image: 'https://ik.imagekit.io/xanalia/xana-genesis/body-5a-facespot-1a-eyes-19c-hairs-33a-clothes-62c-earrings-5a.png',
      mainImage:
          'https://storage.xanalia.com/output/nft-image/94/1663065618839_2.gif',
      nftId: networkType === 'testnet' ? 681 : 45888,
      nftName:
  ...
  {
      collectionAddress: '0x5b5cf41d9EC08D101ffEEeeBdA411677582c9448',
      image: 'https://ik.imagekit.io/xanalia/xana-genesis/body-5a-eyes-18a-hairs-5d-clothes-41e-hairaccessories-16b-earringsright-8b.png',
      mainImage:
          'https://storage.xanalia.com/output/nft-image/94/1663066242795_1.jpeg',
      nftId: networkType === 'testnet' ? 684 : 51700,
      nftName:
          networkType === 'testnet' ? 'testcat auction' : ' #2062 Constanza',
      token_id: networkType === 'testnet' ? '236' : '7250',
      modalUrl:
          'https://api-test-xana.s3.amazonaws.com/xana-genisis/2062/25-30+(1).model3.json',
      isPublic: false,
  ...
  {
      collectionAddress: '0x5b5cf41d9EC08D101ffEEeeBdA411677582c9448',
      image: 'https://ik.imagekit.io/xanalia/xana-genesis/body-2a-eyes-18b-hairs-1b-clothes-71b-hairaccessories-5a.png',
      mainImage: 'models/One Side Glass Girl/Model.jpeg',
      nftId: networkType === 'testnet' ? 684 : 43196,
      nftName: ' #1329 Maisha',
      token_id: networkType === 'testnet' ? '236' : '1329',
  ...
  {
      collectionAddress: '0x5b5cf41d9EC08D101ffEEeeBdA411677582c9448',
      image: 'https://ik.imagekit.io/xanalia/xana-genesis/body-1a-eyes-19c-clothes-83d-hairs-22a-hairaccessories-5c-earrings-19a.png',
      mainImage: 'models/One Side Glass Girl/Model.jpeg',
      nftId: networkType === 'testnet' ? 684 : 43295,
      nftName: ' #1429 Calani',
      token_id: networkType === 'testnet' ? '236' : '1429',
  ...
  {
      collectionAddress: '0x5b5cf41d9EC08D101ffEEeeBdA411677582c9448',
      image: 'https://xanalia.s3.amazonaws.com/xana-genesis-old/6-body-6a-facespot-12a-eyes-12d-clothes-94c-hairs-23f.png',
      mainImage: 'models/One Side Glass Girl/Model.jpeg',
      nftId: networkType === 'testnet' ? 684 : 43840,
      nftName: ' #2062 YAVA',
      token_id: networkType === 'testnet' ? '236' : '2062',
  ...
  {
      collectionAddress: '0x5b5cf41d9EC08D101ffEEeeBdA411677582c9448',
      image: 'https://ik.imagekit.io/xanalia/xana-genesis/body-3a-facespot-10a-eyes-29a-clothes-42e-hairs-6a-earringsleft-6a.png',
      mainImage: 'models/One Side Glass Girl/Model.jpeg',
      nftId: networkType === 'testnet' ? 684 : 43968,
      nftName: ' #2190 Kaedence',
      token_id: networkType === 'testnet' ? '236' : '2190',
  ...
  {
      collectionAddress: '0x5b5cf41d9EC08D101ffEEeeBdA411677582c9448',
      image: 'https://ik.imagekit.io/xanalia/xana-genesis/body-4a-facespot-4a-eyes-3e-clothes-47a-hairs-13i.png',
      mainImage: 'models/One Side Glass Girl/Model.jpeg',
      nftId: networkType === 'testnet' ? 684 : 44195,
      nftName: ' #2419 Yumeka',
      token_id: networkType === 'testnet' ? '236' : '2419',
  ...
  {
      collectionAddress: '0x5b5cf41d9EC08D101ffEEeeBdA411677582c9448',
      image: 'https://ik.imagekit.io/xanalia/xana-genesis/body-2a-facespot-4a-eyes-18a-clothes-43e-hairs-10d-earrings-2b.png',
      mainImage: 'models/One Side Glass Girl/Model.jpeg',
      nftId: networkType === 'testnet' ? 684 : 44593,
      nftName: ' #2817 Kana',
      token_id: networkType === 'testnet' ? '236' : '2817',
  ...
  {
      collectionAddress: '0x5b5cf41d9EC08D101ffEEeeBdA411677582c9448',
      image: 'https://ik.imagekit.io/xanalia/xana-genesis/body-1a-eyes-2a-hairs-35c-clothes-53b.png',
      mainImage: 'models/One Side Glass Girl/Model.jpeg',
      nftId: networkType === 'testnet' ? 684 : 45531,
      nftName: ' #3755 Kalia',
      token_id: networkType === 'testnet' ? '236' : '3755',
  ...
  {
      collectionAddress: '0x5b5cf41d9EC08D101ffEEeeBdA411677582c9448',
      image: 'https://ik.imagekit.io/xanalia/xana-genesis/body-3a-facespot-15a-eyes-32e-clothes-13d-hairs-13b.png',
      mainImage: 'models/One Side Glass Girl/Model.jpeg',
      nftId: networkType === 'testnet' ? 684 : 48934,
      nftName: ' #8336 Miyuka',
      token_id: networkType === 'testnet' ? '236' : '8336',
  ...
  {
      collectionAddress: '0x5b5cf41d9EC08D101ffEEeeBdA411677582c9448',
      image: 'https://ik.imagekit.io/xanalia/xana-genesis/body-2a-facespot-3a-eyes-16d-clothes-54d-hairs-15f.png',
      mainImage: 'models/One Side Glass Girl/Model.jpeg',
      nftId: networkType === 'testnet' ? 684 : 46729,
      nftName: ' #4953 Misha',
      token_id: networkType === 'testnet' ? '236' : '4953',
  ...
  {
      collectionAddress: '0x5b5cf41d9EC08D101ffEEeeBdA411677582c9448',
      image: 'https://ik.imagekit.io/xanalia/xana-genesis/body-6a-eyes-24a-clothes-8b-hairs-27b-hairaccessories-3b.png',
      mainImage: 'models/One Side Glass Girl/Model.jpeg',
      nftId: networkType === 'testnet' ? 684 : 44199,
      nftName: ' #2423 Shizuri',
      token_id: networkType === 'testnet' ? '236' : '2423',
  ...
  {
      collectionAddress: '0x5b5cf41d9EC08D101ffEEeeBdA411677582c9448',
      image: 'https://ik.imagekit.io/xanalia/xana-genesis/body-2a-facespot-11a-eyes-16b-hairs-3e-clothes-21c-earringsright-1b.png',
      mainImage: 'models/One Side Glass Girl/Model.jpeg',
      nftId: networkType === 'testnet' ? 684 : 45222,
      nftName: ' #3446 Inori',
      token_id: networkType === 'testnet' ? '236' : '3446',
  ...
  {
      collectionAddress: '0x5b5cf41d9EC08D101ffEEeeBdA411677582c9448',
      image: 'https://ik.imagekit.io/xanalia/xana-genesis/body-1a-eyes-22b-hairs-32c-clothes-14c-hairaccessories-22a.png',
      mainImage: 'models/One Side Glass Girl/Model.jpeg',
      nftId: networkType === 'testnet' ? 684 : 46193,
      nftName: ' #4417 Roxy',
      token_id: networkType === 'testnet' ? '236' : '4417',
  ...
  {
      collectionAddress: '0x5b5cf41d9EC08D101ffEEeeBdA411677582c9448',
      image: 'https://ik.imagekit.io/xanalia/xana-genesis/body-4a-eyes-14c-clothes-79b-hairs-29f-hairaccessories-10a.png',
      mainImage: 'models/One Side Glass Girl/Model.jpeg',
      nftId: networkType === 'testnet' ? 684 : 46433,
      nftName: ' #4657 Miah',
      token_id: networkType === 'testnet' ? '236' : '4657',
  ...
  {
      collectionAddress: '0x5b5cf41d9EC08D101ffEEeeBdA411677582c9448',
      image: 'https://ik.imagekit.io/xanalia/xana-genesis/body-4a-eyes-16d-hairs-34b-clothes-2a-hairaccessories-26a.png',
      mainImage: 'models/One Side Glass Girl/Model.jpeg',
      nftId: networkType === 'testnet' ? 684 : 49126,
      nftName: ' #8528 Ruby',
      token_id: networkType === 'testnet' ? '236' : '8528',
  ...
  {
      collectionAddress: '0x5b5cf41d9EC08D101ffEEeeBdA411677582c9448',
      image: 'https://ik.imagekit.io/xanalia/xana-genesis/body-4a-eyes-16d-clothes-28e-facepaint-7a-hairs-29e.png',
      mainImage: 'models/One Side Glass Girl/Model.jpeg',
      nftId: networkType === 'testnet' ? 684 : 44349,
      nftName: ' #2573 Yukari',
      token_id: networkType === 'testnet' ? '236' : '2573',
  ...
  {
      collectionAddress: '0x5b5cf41d9EC08D101ffEEeeBdA411677582c9448',
      image: 'https://ik.imagekit.io/xanalia/xana-genesis/body-1a-facespot-15a-eyes-19b-clothes-80f-hairs-18g.png',
      mainImage: 'models/One Side Glass Girl/Model.jpeg',
      nftId: networkType === 'testnet' ? 684 : 48077,
      nftName: ' #7348 Marguerite',
      token_id: networkType === 'testnet' ? '236' : '7348',
  ...
  {
      collectionAddress: '0x5b5cf41d9EC08D101ffEEeeBdA411677582c9448',
      image: 'https://ik.imagekit.io/xanalia/xana-genesis/body-1a-facespot-13a-eyes-9d-clothes-61c-hairs-29e.png',
      mainImage: 'models/One Side Glass Girl/Model.jpeg',
      nftId: networkType === 'testnet' ? 684 : 44832,
      nftName: ' #3056 Anabelle',
      token_id: networkType === 'testnet' ? '236' : '3056',
