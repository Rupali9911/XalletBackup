...
export const languageArray = [
  {
    ...
    language_ja_display: '英語',
    isSelected: true,
    icon: ImagesSrc.english,
  },
  {
    language_id: 3,
    language_name: 'ja',
    language_display: '日本語',
    language_ja_display: '日本語',
    isSelected: true,
    icon: ImagesSrc.japan,
  },
  {
    language_id: 2,
    language_name: 'ko',
    language_display: '한국어',
    language_ja_display: '韓国語',
    isSelected: true,
    icon: ImagesSrc.korea,
  },
  {
    language_id: 5,
    language_name: 'ch',
    language_display: '中文（简体）',
    language_ja_display: '中国語（簡体）',
    isSelected: true,
    icon: ImagesSrc.chinese,
  },
  {
    language_id: 4,
    language_name: 'tw',
    language_display: '中文（繁体）',
    language_ja_display: '中国語（繁体）',
    isSelected: true,
    icon: ImagesSrc.chineseTw,
  },
];
