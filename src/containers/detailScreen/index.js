                ...
                <ScrollView>
                    {
                        nftList.map((v, i) => {
                            return (
                                <View key={i}>
                                    <View style={styles.bgImageCont} >
                                        <Image source={{ uri: v.metaData.image }} style={styles.bgImage} />
                                        <View style={[styles.bgImageCont, { backgroundColor: colors.black_opacity(0.8) }]} />
                                    </View>
                                    <Image source={{ uri: v.metaData.image }} style={styles.modalImage} />

                                    <View style={styles.bottomModal} >
                                        <View style={styles.modalLabelCont} >
                                            <Text style={styles.modalLabel} >{v.metaData.name}</Text>
                                        ...
                                        <View style={styles.separator} />
                                        <Text style={styles.description} >{v.metaData.description}</Text>
                                        <TouchableOpacity>
